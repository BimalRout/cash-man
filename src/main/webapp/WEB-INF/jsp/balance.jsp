...
<jsp:include page="_head.jsp"/>
    ...
    <form role="form"
        ...
        <div class="form-group">
            <label for="number" class="text-center">Card Number</label>
            <input id="number" class="form-control text-center" type="text" value="${number}" readonly>
        </div>
        <hr class="divider"/>
        
         <div class="form-group">
            <label for="twentyDenom" class="text-center">20 Dolar Notes</label>
            <input id="twentyDenom" class="form-control text-center" type="text" value="${twentyDenom}" readonly>
        </div>
        
         <div class="form-group">
            <label for="fiftyDenom" class="text-center">50 Dolar Notes</label>
            <input id="fiftyDenom" class="form-control text-center" type="text" value="${fiftyDenom}" readonly>
        </div>
